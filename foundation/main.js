 ...
 * the header height, the content width, the section rhythm, how far the
 * colour block sits out from behind a photo. Anything that belongs to one
 * section lives in that section's meta.js instead.
 */
export const vars = {
