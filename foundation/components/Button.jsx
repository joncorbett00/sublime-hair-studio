 ...
 *            edge. The brand colour on paper and ink, paper on the brand colour.
 ...
 * lines up exactly.
 *
 * Renders as a Link when given an href, a button otherwise. Pass `reload` for
 * a link to another site under the same domain (see utils/links.js).
 */
const SIZES = {
