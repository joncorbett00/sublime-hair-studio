...
/**
 * The house wordmark, set in type: "sublime" in Bodoni Moda italic (the only
 * place that face is used, with the seal), and
...
export default function Wordmark({ tagline = 'hair studio', className }) {
  return (
    <span className={cn('inline-flex flex-col items-center whitespace-nowrap [line-height:1]', className)}>
      <span className="font-logo font-medium italic tracking-[-0.03em] text-heading">sublime</span>
      <span
